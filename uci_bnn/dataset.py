...
# https://github.com/ICL-SML/Doubly-Stochastic-DGP/blob/master/demos/datasets.py
...
class Dataset(object):
    def __init__(self, name, N, D, type, data_path=''):
    ...
    def get_data(self, seed=1, split=0, prop=0.9):
...
class Yacht(Dataset):
    def __init__(self):
        self.name, self.N, self.D = 'yacht', 307, 7
        self.type = 'regression'
        self.data_path = data_path
